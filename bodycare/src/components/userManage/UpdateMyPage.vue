  ...
  <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <div v-if="!successful">
                <form class="user" @submit.prevent="handleUpdate">
                  ...
                  <div class="form-group">
                    ...
                    <input
                        ...
                        v-validate="'required|min:6|max:200'"
                        name="password"
                    />
                    <div
    ...
    >
      ...
      <router-link to="/mypage">
        <button class="btn btn-primary float-right">내 정보 돌아가기</button>
      </router-link>
      <!-- 추가하기버튼 끝 -->
    </div>
...
export default {
  ...
  methods: {
    ...
    handleUpdate() {
      ...
      this.$validator.validate().then((isValid) => {
        ...
        if (isValid) {
          ...
          this.$store
              .dispatch("auth/userUpdate", this.user)
              //  성공 / 실패 then
              //      성공하면 첫번째 매개변수 실행
              //      실패하면 두번째 매개변수 실행
              .then(
    ...
    saveUser() {
      ...
      UserDataService.updateUsers(id,data)
